...
export default function ThemePage() {
  ...
  if (loadingData) {
    return <div className="min-h-screen flex items-center justify-center text-white/50">Loading your theme…</div>;
  }
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      <div className="mb-6">
        <h1 className="text-xl font-semibold">Theme & animations</h1>
        <p className="text-white/50 text-sm mt-1">
          Customize your portfolio&apos;s branding, colors and animations.
        </p>
      </div>
      ...
      <ThemeEditor data={data} onChange={setData} />
